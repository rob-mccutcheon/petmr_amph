...
python /data/project/AMPH/src/ICA-AROMA-master/ICA_AROMA.py -in smoothed.nii.gz -out ICA_AROMA \
-affmat epireg.mat -warp ../anat/warp.nii.gz -mc resting_mcf.nii.par
...
fslmaths ../anat/fast/structural_pve_0.nii.gz -ero CSFmask_eroded
